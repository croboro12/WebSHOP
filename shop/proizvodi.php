...
include 'Komunikacija.php';
	...
	$query = "SELECT COUNT(*) as br FROM `proizvod`";
	$result=db_select($query);

if($result){
	$UkupnoProizvoda = $result[0]['br'];
}
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="#">Proizvodi</a></li>
      ...
      <ul class="nav navbar-nav navbar-right"> <li> 
		...
		<li><a href="login.php"><span class="glyphicon glyphicon-user"></span>Registriraj se</a></li>
...
echo "Hahhaah";
echo $gornjagranica;*/
$query = "SELECT ID_Proizvod,Naziv,Cijena FROM `proizvod`";	
$result = db_select($query);
...
for($pocetak; $pocetak <= $gornjagranica ; $pocetak++){
	...
	print('<div class="col-xs-6 col-sm-3"  margin-left:10px;"> <div class="panel panel-primary "><div class="panel-heading"><label class="control-label" style="margin-left:40%;">'.$result[$pocetak]["Naziv"].'</label></a></div><div class="panel-body'.$pocetak.'
			...
			" alt="Image" id="slika">
<br><div class="middle'.$pocetak.' style="transition: .5s ease;
  opacity: 0;
  position: absolute;
  top: 50%;
  left: 50%;
  transform: translate(-50%, -50%);
  -ms-transform: translate(-50%, -50%)"">
			<a href="pojedinosti.php?id_slike='.$result[$pocetak]["ID_Proizvod"].'&brojStranice='.$brojstr.'"  class="text" >Informacije</a>
			</div>
