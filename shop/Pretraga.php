  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right"> <li> 
        ...
        <li><span class="glyphicon glyphicon-user"></span><?php if(isset($_SESSION['user'])){
		echo $_SESSION['user'];	
		} else{
...
print('
			<a href="pojedinosti.php?id_slike='.$result[$pocetak]["ID_Proizvod"].'&brojStranice='.$brojstr.'&pretraga='.$_GET['q'].'"  class="text" >Informacije</a>
			</div>
