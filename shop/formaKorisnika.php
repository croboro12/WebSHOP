...
if(isset($_GET['poruka'])){
		...
		print('
				<form method="POST" action="dodajKorisnika.php"  enctype="multipart/form-data">
				<label class="control-label" style="margin-left:0%;">Mail: </label>
				<input type ="text" name= "Mail"></br>
				<label class="control-label" style="margin-left:0%;">Password: </label>
				<input type ="password" name= "Password" value="Password"></br>
				<label class="control-label" style="margin-left:0%;">Ime: </label>
				<input type ="text" name= "Ime" value="Ime"></br>
				<label class="control-label" style="margin-left:0%;">Prezime: </label>
