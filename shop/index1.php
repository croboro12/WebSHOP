...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
	  ...
	  <?php 
		if($_SESSION['ovlasti']==1){
			print('<li><a href="formaNovog.php">DodajZapis</a></li>');
		}
		

        print('<li><a href="Profil.php?id='.$idk.'"><span class="glyphicon glyphicon-user"></span>'.$_SESSION['user'].'</a></li>');
  ...
  print('<div class="col-sm-4" >
      <div class="panel panel-primary" >
        ...
        <div class="panel-body'.$i.'"><img src="dohvatiSliku.php?id='.$rs['ID_Proizvod'].'" width="320" class="img-responsive'.$i.'" style="width:100%; height:350px; "  alt="Image">
			<div class="middle'.$i.'">');
			if($_SESSION['ovlasti']==1){
				print('<a  href="UrediSliku.php?id='.$rs["ID_Proizvod"].'&brojStranice=1" class="text">Kupi</a>');
				print('<a  href="UrediSliku.php?id='.$rs["ID_Proizvod"].'&brojStranice=1" class="text">Uredi</a>');
			}else{
				print('<a  href="UrediSliku.php?id='.$rs["ID_Proizvod"].'&brojStranice=1" class="text">Kupi</a>');
			}
...
<?php }else{
	echo "Nalazite se u zoni za registrirane korisnike</br>";
	print("<a href='index.php'>Povratak na dio za goste!</a>");
} ?>